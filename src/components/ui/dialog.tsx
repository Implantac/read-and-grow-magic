...
>(({ className, children, description, ...props }, ref) => {
  ...
  const ariaDescribedBy = props["aria-describedby"] ?? autoDescId;
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        {/* Hidden fallback description to satisfy a11y when caller didn't provide one */}
        {!props["aria-describedby"] && (
          <DialogPrimitive.Description id={autoDescId} className="sr-only">
            {description ?? "Conteúdo da janela de diálogo"}
