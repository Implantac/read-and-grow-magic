  ...
  return (
    <section className="bg-muted/20 border-y py-20 md:py-28">
      <div className="container mx-auto px-4 lg:px-8 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 tracking-tight">Veja o sistema em funcionamento</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative aspect-video rounded-2xl bg-card border border-primary/20 shadow-xl overflow-hidden group cursor-pointer hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <div className="text-center">
                <div className="h-20 w-20 rounded-full bg-primary/10 border-2 border-primary/30 flex items-center justify-center mx-auto mb-5 group-hover:scale-110 group-hover:bg-primary/15 group-hover:border-primary/40 group-hover:shadow-[0_0_40px_hsl(var(--primary)/0.25)] transition-all duration-500">
