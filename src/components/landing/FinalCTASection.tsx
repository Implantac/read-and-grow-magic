        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="gap-2 text-base px-8 h-14 border-background/25 text-background hover:bg-background/10 hover:-translate-y-0.5 transition-all duration-300 font-semibold"
              onClick={onLogin}
            >
