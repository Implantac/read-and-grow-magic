...
const diffs = [
  { icon: Factory, title: 'Feito para quem produz e vende', desc: 'Projetado para indústrias, atacado, varejo e produção sob encomenda — não é um sistema genérico.', num: '01' },
  { icon: Brain, title: 'IA que trabalha por você', desc: 'Prevê gargalos, prioriza clientes de risco, otimiza picking e sugere ações automaticamente.', num: '02' },
  ...
  { icon: Gauge, title: 'Integração nativa de ponta a ponta', desc: 'Comercial, produção, estoque, logística, financeiro e fiscal — tudo conectado, zero retrabalho.', num: '04' },
  { icon: ShieldCheck, title: 'Segurança e conformidade', desc: 'Dados criptografados, backup automático, LGPD nativo e 99.9% de disponibilidade garantida.', num: '05' },
  { icon: Target, title: 'ROI mensurável', desc: 'Clientes recuperam o investimento em semanas com redução de erros e ganho de eficiência.', num: '06' },
];
    ...
    <section className="bg-muted/20 border-y border-border/50 py-20 md:py-28">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-14">
          <Badge variant="outline" className="mb-4 font-medium px-4 py-1">Diferenciais</Badge>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 tracking-tight">
            Por que escolher a <span className="text-gradient-primary">USE SISTEMAS?</span>
          </h2>
          <p className="text-muted-foreground text-base md:text-lg max-w-xl mx-auto">
            Não é só um sistema. É uma plataforma completa que combina gestão integrada, inteligência artificial e visão 360° do negócio.
          </p>
        </div>
