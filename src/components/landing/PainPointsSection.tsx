...
const pains = [
  ...
  { icon: TrendingUp, title: 'Crescimento travado', desc: 'Quanto mais vende, mais caos. Escalar sem sistema é prejuízo.', stat: '2x', statLabel: 'mais caro operar' },
];
    ...
    <section id="problemas" className="container mx-auto px-4 lg:px-8 py-20 md:py-28">
      ...
      <div className="grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        {pains.map((pain) => (
          <Card
            key={pain.title}
            className="group border-border/50 bg-card hover:border-destructive/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
