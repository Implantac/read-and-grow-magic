  ...
  return (
    <PageContainer>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Total a Receber" value={formatCurrency(summaryData.total)} icon={<DollarSign className="h-5 w-5" />} accentColor="primary" />
        ...
        <KPICard title="Recebido" value={formatCurrency(summaryData.received)} icon={<CheckCircle className="h-5 w-5" />} accentColor="success" />
      </div>
