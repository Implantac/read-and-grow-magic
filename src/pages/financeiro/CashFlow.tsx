...
import { mockCashFlow, cashFlowChartData, expensesByCategory, financialSummary } from '@/data/financialMockData';
...
export default function CashFlow() {
  const [entries] = useState<CashFlowEntry[]>(mockCashFlow);
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(financialSummary.projectedBalance)}</div>
