...
import { useForecastCalculation } from '@/hooks/useSalesForecasts';
  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <KPICard title="Confirmado" value={fmt(forecast?.confirmedValue || 0)} icon={Target} index={0} />
        <KPICard title="Conservador" value={fmt(forecast?.conservative || 0)} icon={BarChart3} index={1} />
        <KPICard title="Realista" value={fmt(forecast?.realistic || 0)} icon={TrendingUp} index={2} />
        <KPICard title="Otimista" value={fmt(forecast?.optimistic || 0)} icon={Zap} index={3} />
      </div>
