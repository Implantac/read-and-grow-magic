    ...
    items: [
      {
        ...
        children: [
          ...
          { title: 'Régua de Cobrança', href: '/financeiro/cobranca-automatica', icon: 'Bell' },
          { title: 'Recorrências', href: '/financeiro/recorrencias', icon: 'Repeat' },
          { title: 'Inadimplência', href: '/financeiro/inadimplencia', icon: 'TrendingDown' },
          { title: 'Cenários de Caixa', href: '/financeiro/cenarios', icon: 'LineChart' },
          { title: 'Alertas Inteligentes', href: '/financeiro/alertas', icon: 'AlertTriangle' },
